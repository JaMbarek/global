...
apollo_config_db_url=jdbc:mysql://192.168.204.10:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=root

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://192.168.204.10:3306/ApolloPortalDB?characterEncoding=utf8
...
# meta server url
config_server_url=http://192.168.204.10:8080
admin_server_url=http://localhost:8090
eureka_service_url=$config_server_url/eureka/
portal_url=http://192.168.204.10:8070

# JAVA OPTS
BASE_JAVA_OPTS="-Denv=dev"
CLIENT_JAVA_OPTS="$BASE_JAVA_OPTS -Dapollo.meta=$config_server_url"
SERVER_JAVA_OPTS="$BASE_JAVA_OPTS -Dspring.profiles.active=github -Deureka.service.url=$eureka_service_url -Dspring.jpa.database-platform=org.hibernate.dialect.MySQLDialect"
PORTAL_JAVA_OPTS="$BASE_JAVA_OPTS -Ddev_meta=$config_server_url -Dspring.profiles.active=github,auth -Dspring.jpa.database-platform=org.hibernate.dialect.MySQLDialect"
