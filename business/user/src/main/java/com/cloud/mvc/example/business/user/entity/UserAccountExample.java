...
public class UserAccountExample {
    ...
    public UserAccountExample start(int start) {
        this.start=start;
        return this;
    }
    ...
    public UserAccountExample limit(int limit) {
        this.limit=limit;
        return this;
    }
    ...
    public static UserAccountExample create() {
        return new UserAccountExample();
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andPhoneLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("phone like", value, "phone");
        ...
        public Criteria andPhoneNotLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("phone not like", value, "phone");
        ...
        public Criteria andEmailNotLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("email not like", value, "email");
        ...
        public Criteria andLoginPasswordLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("login_password like", value, "loginPassword");
        ...
        public Criteria andLoginPasswordNotLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("login_password not like", value, "loginPassword");
        ...
        public Criteria andDealPasswordLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("deal_password like", value, "dealPassword");
        ...
        public Criteria andDealPasswordNotLikeBoth(String value) {
            if(value != null){
                value = "%" + value + "%";
            }
            addCriterion("deal_password not like", value, "dealPassword");
